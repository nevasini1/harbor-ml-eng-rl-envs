...
Run:  modal run tasks/sciml-protein-regression/scripts/modal_mol_headroom.py
"""
...
image = (
    ...
    .add_local_file("research/split/agent/bbbp_train.csv", "/data/bbbp_train.csv")
    .add_local_file("research/split/private/bbbp_test.csv", "/data/bbbp_test.csv")
)
