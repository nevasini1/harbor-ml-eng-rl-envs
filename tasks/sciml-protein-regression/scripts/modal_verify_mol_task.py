...
existed. research/assemble_task.py generates them, but it silently skipped the
...
Run:  modal run tasks/sciml-protein-regression/scripts/modal_verify_mol_task.py
"""
