...
Run:  modal run sciml-protein-regression/scripts/modal_bbbp_split.py
"""
...
image = (
    ...
    .add_local_file("spike/split/agent/bbbp_train.csv", "/data/bbbp_a.csv")
    .add_local_file("spike/split/private/bbbp_test.csv", "/data/bbbp_b.csv")
    .add_local_file("spike/PRIVATE_SEED", "/data/PRIVATE_SEED")
)
