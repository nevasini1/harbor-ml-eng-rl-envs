...
```bash
V=spike/.venv/bin/python
$V spike/posttrain/fetch_data.py            # corpora, recorded with sha256 pins
$V spike/posttrain/pin_models.py            # checkpoint revisions + file hashes
...
$V spike/posttrain/make_splits.py --track qa --qa-train 4000 --qa-test 600
$V spike/posttrain/make_splits.py --track rm --rm-train 40000 --rm-test 4000 \
    --rm-eval-sets helpful_base,helpful_rs,online,harmless

modal run spike/posttrain/modal_measure.py --track qa --seeds 5   # ~16 containers
modal run spike/posttrain/modal_measure.py --track rm --seeds 5   # ~21 containers
$V spike/posttrain/finalize_anchors.py --markdown                 # anchors + ship/no-ship
$V spike/posttrain/assemble_tasks.py                              # populate the task trees
...
`make_splits.py` needs `spike/posttrain/PRIVATE_SEED`. `assemble_tasks.py` refuses to run
